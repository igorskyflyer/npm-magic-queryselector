...
Hello, thank you for using Magic querySelector! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-magic-queryselector/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-magic-queryselector/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-magic-queryselector/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - Magic querySelector version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-magic-queryselector/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-magic-queryselector/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Magic querySelector:
...
<div align="center">
  Thank you for using Magic querySelector!
  <br>
