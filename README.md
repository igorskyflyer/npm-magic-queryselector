...
|:---:|:---:|:---:|:---:|:---:|
| Descendant | div video | ✅ | Patched | Returns the type of the selected element, `HTMLVideoElement`. <br> Warning: inferring is very sensitive, the selector must follow the syntax: `parent > child`, with one space before and after the `>`. |
